...
let mapData = (n) => {
  ...
  for (let i=1; i<=n; i++){
    data.push({
	  ...
	  date1:Mock.mock('@integer(8, 22)'),
	  date2:Mock.mock('@integer(0, 59)'),
      detail:{
...
module.exports = Mock.mock({
  ...
  'user': {
	...
	"money":Mock.mock('@float(60, 100, 2, 5)'),
	
	
  },
  'wallet':{
	  "zi":Mock.mock('@float(600, 800, 1, 5)'),
	  "fen":Mock.mock('@float(600, 800, 1, 5)'),
	  "wang":Mock.mock('@float(600, 800, 1, 5)'),
	  "yu":Mock.mock('@float(600, 800, 1, 5)')
  },
